window.COVA_DATA = {
  ...
  stepZero: {
    ...
    curriculum: [
      { step: "탐구 체험", content: "다양한 재료와 도구를 만져보고, 형태·질감·색채를 자유롭게 실험", time: "15분" },
      { step: "표현 활동", content: "평면 작업(그리기, 색채 실험)과 입체 작업(종이·클레이·조형물 만들기)을 다양하게 시도", time: "20분" },
      { step: "기록 습관", content: "작업 중 떠오른 생각이나 발견을 간단히 스케치·메모", time: "5분" },
      { step: "언어화 연습", content: "\"오늘 재미있었던 점은?\", \"어려웠던 점은?\"을 1~2문장으로 표현", time: "5분" }
    ],
    philosophy: {
