window.COVA_DATA = {
  ...
  kickoff: {
    ...
    // 주요 학습 내용 (단계별)
    curriculum: [
      { step: "1. 시작 — 질문 받기", content: "매주 새로운 질문 제시: \"왜?\", \"어떻게?\"를 스스로 던지며 사고 확장.", time: "" },
      { step: "2. 탐구 — 관찰과 아이디어", content: "주변 사물이나 장면을 관찰 → 짧은 생각 기록(3~5줄).", time: "" },
      { step: "3. 표현 — 간단한 드로잉", content: "떠오른 생각을 가볍게 그림으로 표현. 완성이 아니라 시도에 집중.", time: "" },
      { step: "4. 정리 — 공유와 피드백", content: "기록·드로잉을 간단히 설명/ 발견 중심의 교사 피드백", time: "" }
    ],
