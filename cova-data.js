window.COVA_DATA = {
  ...
  kickoff: {
    ...
    overview: {
      title: "프로그램 개요",
      content: "KICK-OFF는 매주 월요일 25분 동안 진행되는 예열 루틴 프로그램입니다.\n\n작은 질문과 기록, 간단한 표현 활동으로 수업 몰입을 돕고, 한 주의 시작을 활기차게 여는 역할을 합니다. '왜?', '어떻게?'를 스스로 던지며 사고를 확장하고, 짧은 드로잉과 디지털 프로세스 폴리오 기록을 통해 탐구하는 습관을 기릅니다."
    },
  ...
  kpi: {
    description: "COVA는 루드릭평가서를 통한 정량/ 정성평가와 함께 학생이 남긴 흔적의 무게와 과정의 깊이를 기록합니다.",
    common: ["탐구의 지표","기록의 지표","언어화의 지표","성과의 지표"],
    indicators: [
      {
        category: "탐구의 지표",
        questions: [
      ...
      },
      {
        category: "성과의 지표",
        questions: [
          "한 달 동안 몇 장의 성과 카드가 남았는가?",
          "그 안에서 어떤 변화가 읽히는가?"
        ]
      }
    ],
    reports: {
      description: "COVA는 성장을 숨기지 않습니다.\n성장을 학생, 학부모, 교사가 함께 확인할 수 있습니다.",
      types: [
        {
          category: "학생 리포트",
          items: [
            "내 손으로 남긴 Before/After",
            "디지털 프로세스 폴리오 성과 카드",
            "\"이번 달 나는 ~를 새롭게 해봤다.\"라는 자기 성찰 한 줄"
          ]
        },
        {
          category: "학부모 리포트", 
      ...
      conclusion: "리포트는 평가가 아니라, 함께 성장의 여정을 확인하는 지도입니다."
    }
  },

  faq: [
    ["변화하는 미대입시",
     "마산 김해 미대입시 전문 미술학원 코코는 수년간 축척된 객관적 데이터와 최적화된 커리큘럼으로, 변화하는 미대입시 구조와 실기과목에 완벽하게 대응, 발전하는 커리큘럼으로 지도합니다."],
    ["사고력, 창의력 학습 시스템",
     "코코의 사고력, 창의력 학습 COVA는 [FOLLOW-ALL IN ONE] 시스템을 통해 시작부터 마무리까지, 전 과정을 경험할 수 있도록 설계되어 있습니다."],
    ["대상",
     "미술진로/ 미대진학을 목표로 하는 중등, 고등1, 고등2 학년"]
  ]
};