window.COVA_DATA = {
  ...
  kickoff: {
    ...
    // 주요 학습 내용 (단계별)
    curriculum: [
      { step: "준비", content: "기본 도구 사용법과 올바른 자세", time: "10분" },
      { step: "관찰", content: "선 연습과 형태 관찰 방법", time: "20분" },
      { step: "이해", content: "비례와 구도의 기본 이해", time: "15분" },
      { step: "실습", content: "실습을 통한 실전 경험", time: "40분" },
      { step: "피드백", content: "개별 맞춤 피드백과 보완점 도출", time: "15분" }
    ],
    ...
    // 커리큘럼 (단계별 안내)
    expectedOutcomes: [
      "1. 시작 — 질문 받기\n-매주 새로운 질문 제시 : \"왜?\", \"어떻게?\"를 스스로 던지며 사고 확장.",
      "2. 탐구 — 관찰과 아이디어\n-주변 사물이나 장면을 관찰 → 짧은 생각 기록.",
      "3. 표현 — 간단한 드로잉\n-떠오른 생각을 가볍게 그림으로 표현. 완성이 아니라 시도에 집중.",
      "4. 정리 — 공유와 피드백\n-기록·드로잉을 간단히 설명. 교사 피드백은 칭찬과 발견 중심."
    ],
